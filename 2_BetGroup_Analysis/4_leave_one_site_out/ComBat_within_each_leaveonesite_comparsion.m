...
datapath='/home1/zhangyj/Desktop/MDD/MDD_GBC/1_GBC_calculate/D2_GBCMap_AAL90';
outpath='/home1/zhangyj/Desktop/MDD/MDD_GBC/2_BetGroup_Analysis/4_leave_one_site_out';
file1=dir([datapath,'/*HC_*Zmean.nii']);
file2=dir([datapath,'/*MDD_*Zmean.nii']);
...
for c=1:10
    ...
    [TTest2_T,Header] = y_TTest2_Image(DepDirs,[outpath,'/wGBCr_T2_hc_mdd_',Center{c}],Mask_dir,[],Covariates);
    [GRF_Data_Corrected,ClusterSize,GRF_Header]=GRF([outpath,'/wGBCr_T2_hc_mdd_',Center{c}],voxel_p,1,cluster_p,[outpath,'/wGBCr_T2_hc_mdd_GRF_',Center{c},'_Vp0001_twotail'],Mask_dir);
end
