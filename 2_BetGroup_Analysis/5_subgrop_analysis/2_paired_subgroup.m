...
[TTest2_T,Header] = y_TTest2_Image(DependentDirs,'wGBCr_T2_Med_NoMed',MaskFile,[],Covariates);
[Data_Corrected, Header]=GRF('wGBCr_T2_Med_NoMed',0.001,1,0.05,'wGBCr_T2_Med_NoMed_GRF',MaskFile);
BrainNet_MapCfg(surfacefile,'wGBCr_T2_Med_NoMed_GRF.nii',Cgf,'wGBCr_T2_Med_NoMed_GRF.tif');

%% FE vs. RE
Covariates={Cov(ind_FE,:);Cov(ind_RE,:)};   
DependentDirs={data(ind_FE,:);data(ind_RE,:)};
[TTest2_T,Header] = y_TTest2_Image(DependentDirs,'wGBCr_T2_FE_RE',MaskFile,[],Covariates);
[Data_Corrected, Header]=GRF('wGBCr_T2_FE_RE',0.001,1,0.05,'wGBCr_T2_FE_RE_GRF',MaskFile);
BrainNet_MapCfg(surfacefile,'wGBCr_T2_FE_RE_GRF.nii',Cgf,'wGBCr_T2_FE_RE_GRF.tif');

%% Onset>21 vs. Onset<21
Covariates={Cov(ind_onsetS21,:);Cov(ind_onsetB21,:)};   
DependentDirs={data(ind_onsetS21,:);data(ind_onsetB21,:)};
[TTest2_T,Header] = y_TTest2_Image(DependentDirs,'wGBCr_T2_OA',MaskFile,[],Covariates);
[Data_Corrected, Header]=GRF('wGBCr_T2_OA',0.001,1,0.05,'wGBCr_T2_OA_GRF',MaskFile);
BrainNet_MapCfg(surfacefile,'wGBCr_T2_OA_GRF.nii',Cgf,'wGBCr_T2_OA_GRF.tif');
