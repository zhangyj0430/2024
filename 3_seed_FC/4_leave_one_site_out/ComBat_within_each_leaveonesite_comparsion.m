...
outpath='/home1/zhangyj/Desktop/MDD/MDD_GBC/3_seed_FC/4_leave_one_site_out';
...
for k=1:8
    file1=dir([path,'/z*',ROI{k},'*HC_*.nii']);
    file2=dir([path,'/z*',ROI{k},'*MDD_*.nii']);
    ...
    for c=1:10
        ...
        [TTest2_T,Header] = y_TTest2_Image(DepDirs,[outpath,'/Result_LeaveOS/wGBCr_T2_hc_mdd_',ROI{k},Center{c}],Mask_dir,[],Covariates);
        [GRF_Data_Corrected,ClusterSize,GRF_Header]=GRF([outpath,'/Result_LeaveOS/wGBCr_T2_hc_mdd_',ROI{k},Center{c}],voxel_p,1,cluster_p,[outpath,'/Result_LeaveOS/wGBCr_T2_hc_mdd_GRF_',ROI{k},Center{c},'_Vp0001_twotail'],Mask_dir);
        BrainNet_MapCfg(surfacefile,[outpath,'/Result_LeaveOS/wGBCr_T2_hc_mdd_GRF_',ROI{k},Center{c},'_Vp0001_twotail.nii'],Cgf,[outpath,'/Result_LeaveOS/wGBCr_T2_hc_mdd_GRF_',ROI{k},Center{c},'_Vp0001_twotail.tif'])   
    end
end
