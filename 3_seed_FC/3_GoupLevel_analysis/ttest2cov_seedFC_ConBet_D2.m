...
for g=1:8
    ...
    [TTest2_T,Header] = y_TTest2_Image(DependentDirs,['wGBCr_T2_mdd_hc_',ROI{g}],Mask,[],Covariates);
    [GRF_Data_Corrected,ClusterSize,GRF_Header]=GRF(['wGBCr_T2_mdd_hc_',ROI{g}],voxel_p,1,cluster_p,['wGBCr_T2_mdd_hc_GRF_',ROI{g},'_',str],Mask);
end
...
for g=1:8
    ...
    DependentDirs={mdd;hc};
    [TTest2_T,Header] = y_TTest2_Image(DependentDirs,['adult_wGBCr_T2_mdd_hc_',ROI{g}],Mask,[],Covariates);
    [GRF_Data_Corrected,ClusterSize,GRF_Header]=GRF(['adult_wGBCr_T2_mdd_hc_',ROI{g}],voxel_p,1,cluster_p,['adult_wGBCr_T2_mdd_hc_GRF_',ROI{g},'_',str],Mask);
end
